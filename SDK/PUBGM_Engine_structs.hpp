...
struct FGerstnerWaterWaveGeneratorSimple
{
	...
	TArray<struct FGerstnerWave>                       GerstnerWaves;                                            // 0x003C(0x000C) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
};
...
struct FUserDetailSetting
{
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0025(0x0003) MISSED OFFSET
	float                                              UserMCSSetting;                                           // 0x0028(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                UserShadowSetting;                                        // 0x002C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                UserShadowSwitch;                                         // 0x0030(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                UserTeamQualityEnhanceSetting;                            // 0x0034(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGLimitSetting;                                         // 0x0038(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceUpdateFlag;                                     // 0x003C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSDef;                                         // 0x0040(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSLow;                                         // 0x0044(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSMid;                                         // 0x0048(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSHigh;                                        // 0x004C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSHDR;                                         // 0x0050(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                PUBGDeviceFPSUltralHigh;                                  // 0x0054(0x0004) (ZeroConstructor, IsPlainOldData)
	bool                                               IsSupportTagCulling;                                      // 0x0058(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0059(0x0003) MISSED OFFSET
	int                                                PUBGTeamQualityEnhance;                                   // 0x005C(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                UserVulkanSetting;                                        // 0x0060(0x0004) (ZeroConstructor, IsPlainOldData)
};
